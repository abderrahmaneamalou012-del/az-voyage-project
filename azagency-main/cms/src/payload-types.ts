...
export interface Config {
  ...
  collectionsSelect: {
    ...
    'destination-filters': DestinationFiltersSelect<false> | DestinationFiltersSelect<true>;
...
export interface Media {
  id: string;
  /**
   * Collez une URL d'image/video si vous ne telechargez pas de fichier.
   */
...
export interface Destination {
  ...
  href?: string | null;
  /**
   * Sélectionnez le groupe de destination auquel cette destination appartient (ex: Tanzanie, Maroc)
   */
  destinationFilter?: (string | null) | DestinationFilter;
  updatedAt: string;
  createdAt: string;
}
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "destination-filters".
 */
export interface DestinationFilter {
  id: string;
  /**
   * Par exemple: Tanzanie, Maroc, Égypte, etc.
   */
  name: string;
  slug?: string | null;
  /**
   * Description du groupe de destinations
   */
  description?: string | null;
  updatedAt: string;
  createdAt: string;
...
export interface Reservation {
  ...
  offerId?: string | null;
  /**
   * Nom affiché de l'hôtel sélectionné.
   */
  selectedHotel: string;
  /**
   * Relation vers la fiche hôtel complète.
   */
...
export interface PayloadLockedDocument {
  ...
  document?:
    ...
    | ({
        ...
        value: string | DestinationFilter;
      } | null)
    | ({
        relationTo: 'hotels';
        value: string | Hotel;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "destination-filters_select".
 */
export interface DestinationFiltersSelect<T extends boolean = true> {
  name?: T;
  slug?: T;
  description?: T;
  updatedAt?: T;
